...
<a href="delete.jsp" class="btn btn-primary">Delete Article</a>
<a href="ajouter.jsp" class="btn btn-primary">Add New Article</a>

<%@include file="articles.jsp"%>
<%@include file="ajouter.jsp"%>
<%@include file="delete.jsp"%>
<%@include file="edit.jsp"%>
<%@include file="ajouterUser.jsp"%>
<%@include file="mdp.jsp"%>
